...
<div class="WB_xline1 oauth_xline" id="outer">
 <div class="oauth_wrap">
    ...
    <form name="authZForm" action="/yunlu1/Oauth/getUserInfo" method="post" node-type="form">
      <div class="oauth_content">
        	
        <!-- 登录 -->
        	<div class="oauth_login clearfix">
	          <!-- <form name="authZForm" action="authorize" method="post" node-type="form"> -->
	          	   <input name="accessToken" id="accessToken" value="${accessToken }" type="hidden">
	       	       <input name="userid" value="${userid }" type="hidden">
				   
				
						<div>
						  <input type="submit" name="sub" id="sub" value="我是第三方  facebook，安智论坛，教育网等等，通过accesstoken获取用户信息.">
